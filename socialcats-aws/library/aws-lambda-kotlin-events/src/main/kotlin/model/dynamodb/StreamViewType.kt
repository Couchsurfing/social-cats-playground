...
public enum class StreamViewType(private val value: String) {
    NEW_IMAGE("NEW_IMAGE"), OLD_IMAGE("OLD_IMAGE"), NEW_AND_OLD_IMAGES("NEW_AND_OLD_IMAGES"), KEYS_ONLY(
        "KEYS_ONLY"
    );
    ...
    public companion object {
         ...
         */
        public fun fromValue(value: String?): StreamViewType {
