...
//        val firestore = module.provideFirestore()
    ...
    val searchUseCase = module.provideSearchUseCase(esClient, moshi)
...
class AppModule {
  ...
  fun provideSearchUseCase(esClient: RestHighLevelClient, moshi: Moshi) =
    ElasticSearchUseCase(esClient, moshi)
}
